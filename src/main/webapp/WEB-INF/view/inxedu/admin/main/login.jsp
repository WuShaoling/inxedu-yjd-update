...
<div id="container">
    <div class="logo">
        <a href="http://www.sit.edu.cn" target="_blank" title="上海应用技术大学">
            <%--<img src="${ctx}/static/admin/assets/logo.png" width="200" alt="上海应用技术大学" />--%>
        </a>
    </div>
</div>
    ...
    <div id="container">
        <div id="box">
            ...
            <form action="${ctx}/admin/main/login" method="POST" id="loginForm">
                <p class="main">
                    <label>用户名: </label>
                    <input name="sysUser.loginName" onkeyup="enterSubmit(event)" value="${sysUser.loginName}"
                           placeholder="输入用户名"/>
                    <label>密码: </label>
                    <input type="password" onkeyup="enterSubmit(event)" name="sysUser.loginPwd"
                           value="${sysUser.loginPwd}" placeholder="输入密码">
                </p>
                <p class="main">
                    <label>验证码: </label>
                    <input name="randomCode" onkeyup="enterSubmit(event)" placeholder="验证码" style="width: 105px;"
                           maxlength="4"/>
                    <span class="yzm-pic">
