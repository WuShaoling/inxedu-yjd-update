    ...
    <div>
        ...
        <div id="header">
            ...
            <div id="top">
                <!-- Logo -->
                <div class="logo">
                    <a href="http://www.sit.edu.cn" target="_blank" title="上海应用技术大学" class="tooltip">
                        <img src="${ctx}/static/admin/assets/logo.png" height="60" alt="上海应用技术大学"/>
                    </a>
                </div>
                <!-- End of Logo -->
...
<div id="container">
    ...
    <div id="bgwrap">
        ...
        <div id="content">
            <div id="main">
                <div id="right">
                    <iframe id="mainFrame" name="mainFrame" src="${ctx}/admin/main/index" style="overflow:visible;"
    ...
    <div id="footer">
        ...
        <p class="mid">
            Powered By <a target="_blank" href="http://www.sit.edu.cn"
                          style="color: #666;">${websitemap.web.company}</a>
        </p>
    </div>
    <script type="text/javascript">
        $(function () {
